...
::: {.callout-note title="内容有更新"}

[Folo：一年之后](/posts/follow-after-a-year.qmd)
...
![](./images/follow-app-contentview.webp)
![](./images/follow-app-main-interface.webp)
...
![](./images/follow-app-creator-incentives.webp)
...
![](./images/follow-app-sociality.webp)


不仅如此，你可以利用这个功能创建「合订本」分享或者销售你的作品给你的观众。
![](./images/follow-app-lists.webp)
